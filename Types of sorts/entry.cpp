/**
  * @file
  * @brief Файл содержит перегрузки операторов и определения функций считывания данных из csv-файла
  * и записи в csv-файл.
...
void Entry::to_csv(std::ostream& fout, char sep)
{
    fout << name_ << sep
         << age_ << sep
         << height_ << sep
...
//    std::cout << "find name: " << name << '\n';
//    std::cout << "lin.peek = " << static_cast<char>(lin.peek()) << '\n';
